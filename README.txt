...
1) скачать последнюю версию python c сайты https://www.python.org/downloads/release/python-370/
...
4) открыть коммандную строку:
        ...
        - перейти в командной строке в директорию с папкой env и активировать виртуальное окружение
